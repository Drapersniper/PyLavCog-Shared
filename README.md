[![pre-commit.ci status](https://results.pre-commit.ci/badge/github/Drapersniper/PyLavCog-Shared/main.svg)](https://results.pre-commit.ci/latest/github/Drapersniper/PyLavCog-Shared/main)
